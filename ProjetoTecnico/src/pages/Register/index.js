...
export default class Register extends Component {
  ...
  render() {
    const {email,password,nome,telefone,cep,cpf,cnpj} = this.state
    return <div>
        ...
        <form onSubmit={this.submitHandler}>
            ...
            <div className="form-group">
                <div className="form-group">
                    ...
                    name="nome" value={nome} value="NOMEEEEE" placeholder="Nome" required="required" 
                    />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                    ...
                    id={password} pattern="\d{6,}" name="password" placeholder="Senha" required="required" 
                    />
                </div>
                <div className="form-group">
                    <input type="password" onChange={this.changeHandler} value={password} name='password' 
                    className="form-control" id="confirm_password" pattern="\d{6,}" placeholder="Confirmar Senha" 
