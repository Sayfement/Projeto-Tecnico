    ...
    axios.post('http://10.150.1.115:8000/authentication/login.php', this.state)
      .then(response => {
        ...
        if(response.data.result === "OK") {
          const user = new UserModel(this.state.email, response.data.aditional);
            ...
            <section className="Login1">
              <div className="lgn">
                ...
                <form onSubmit={this.submitHandler}>
                  ...
                  <button type="submit" className="btn btn-primary btn-sm border-0" role="button" 
                  id="enter" onClick={() => this.login()}>Entrar</button>
